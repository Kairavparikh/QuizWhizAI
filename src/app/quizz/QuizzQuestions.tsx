        ...
        return (
                ...
                <div>
                    ...
                    <div className = "grid grid-cols-1 gap-6 mt-6">
                    {
                        ...
                        (answer => {
                            ...
                            return (<Button key = {answer.id} disabled = {!!selectedAnswer} variant = {variant} size = "xl" onClick={() => handleAnswer(answer, questions[currentQuestion].id)} className = "disabled:opacity-100">
          ...
          <footer className = "footer pb-9 px-6 relative mb-0">
            <ResultCard isCorrect = {isCorrect} correctAnswer = {questions[currentQuestion].answers.find(answer => answer.isCorrect === true)?.answerText || ""}/>
                {
                    (currentQuestion === questions.length -1) ? <Button size="lg" variant = "neo" onClick={handleSubmit}>Submit</Button> :      <Button size="lg" variant = "neo" onClick={handleNext}> {!started ? 'Start' : 'Next'}
            </Button>
                }
