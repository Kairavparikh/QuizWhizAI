        ...
        return (
          ...
          <main className="flex justify-center flex-1">
            {!started ? <h1 className="text-3xl font-bold">Hello World👋</h1> :(
                <div>
                    <h2 className = "text-3xl font-bold">{questions[currentQuestion].questionsText}</h2>
          ...
          <footer className = "footer pb-9 px-6 relative mb-0">
            ...
            <Button size="lg" variant = "neo" onClick={handleNext}> {!started ? 'Start' : (currentQuestion === questions.length -1) ? 'Submit': 'Next'}
            </Button>
          </footer>
          </div>
        )
